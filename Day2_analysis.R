...
td<-"../working_data"
refs <- dir("../working_data", "sequence.fasta",full.names =TRUE)
...
system("tar -zxvf ../working_data/mutant1_OIST-2015-03-28.fq.tar.gz") #this output is generated in /R/ folder

#generate the sam file-
reads_1 <- "mutant1_OIST-2015-03-28.fq"
