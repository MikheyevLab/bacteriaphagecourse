...
Step6:Variant Calling- generated using "Freebayes" software. This step was performed locally.
Visualize the variant calling file (.vcf file) and filter it.
...
gff_file <- dir("../raw_data/", "annotation.sorted.gff3", full.names = TRUE)
...
#filter the variants-
chrom <- masker(chrom, min_QUAL=0, min_DP=10, max_DP=800, min_MQ=0)
...
Step7- Use IGV to visualize the variants against the reference genome-https://igv.org/app/ OR have a look at the saved session " ".
